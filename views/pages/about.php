...
<body>
        ...
        <div class="mag-main-menu" id="sticker">
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="magNav">
                    ...
                    <!-- Nav brand -->
                    <a href="index.html" class="nav-brand"><img src="/templates/img/core-img/logo.png" alt=""></a>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="footer-widget">
                        <!-- Logo -->
                        <a href="index.html" class="foo-logo"><img src="/templates/img/core-img/logo2.png" alt=""></a>
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="single-blog-post style-2 d-flex">
                            <div class="post-thumbnail">
                                <img src="/templates/img/bg-img/12.jpg" alt="">
                            </div>
                        ...
                        <div class="single-blog-post style-2 d-flex">
                            <div class="post-thumbnail">
                                <img src="/templates/img/bg-img/13.jpg" alt="">
                            </div>
                            <div class="post-content">
    ...
    <!-- jQuery-2.2.4 js -->
    <script src="/templates/js/jquery/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    <script src="/templates/js/bootstrap/popper.min.js"></script>
    <!-- Bootstrap js -->
    <script src="/templates/js/bootstrap/bootstrap.min.js"></script>
    <!-- All Plugins js -->
    <script src="/templates/js/plugins/plugins.js"></script>
    <!-- Active js -->
